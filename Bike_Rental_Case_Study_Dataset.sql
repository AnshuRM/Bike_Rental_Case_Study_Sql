create database Bike_Rental_Case_Study;    -- creating database
use Bike_Rental_Case_Study;                -- choosing database

drop table if exists customer;             -- if already exists
create table customer                      -- new table creation
(
	id		int primary key,               -- int for integers, primary key contains unique and null values
	name	varchar(30),                   -- variable characters 'atmost 30'
	email	varchar(50)                    
);
